...
export const schema = appSchema({
  ...
  tables: [
    ...
    tableSchema({
      name: 'reevaluation_assessments',
      columns: [
        { name: 'remote_id', type: 'string', isIndexed: true },
        { name: 'patient_id', type: 'string', isIndexed: true },
        { name: 'visit_id', type: 'string', isOptional: true },
        { name: 'clinic_id', type: 'string' },
        { name: 'baseline_assessment_id', type: 'string', isOptional: true },
        { name: 'assessment_type', type: 'string', isIndexed: true },
        { name: 'measure_label', type: 'string' },
        ...
        { name: 'mcid_threshold', type: 'number', isOptional: true },
        { name: 'mcid_achieved', type: 'boolean' },
    ...
    tableSchema({
      ...
      columns: [
        ...
        { name: 'description', type: 'string', isOptional: true },
        { name: 'description_vi', type: 'string', isOptional: true },
